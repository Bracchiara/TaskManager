...
public class BoardService : IBoardService
{
    ...
    public async Task<BoardDTO> CreateAsync(CreateBoardDTO createBoardDto, Guid userId)
    {
        ...
        {
            new Column { Id = Guid.NewGuid(), Name = "Backlog", Order = 1, BoardId = board.Id},
            new Column { Id = Guid.NewGuid(), Name = "To Do", Order = 2, BoardId = board.Id},
            new Column { Id = Guid.NewGuid(), Name = "In Progress", Order = 3, BoardId = board.Id},
            new Column { Id = Guid.NewGuid(), Name = "Review", Order = 4, BoardId = board.Id},
            new Column { Id = Guid.NewGuid(), Name = "Done", Order = 5, BoardId = board.Id},
        };
